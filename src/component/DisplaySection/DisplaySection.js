...
import img2 from "../Assets/dp-img2.png";
        ...
        <div className='mx-[320px] mt-[25px]'>
            ...
            <div  className='flex gap-[51px]'>
                <div className='display-first-section'>
                    ...
                    <img src={img1} className="absolute -z-10" alt="" />
                    ...
                    <img src={orange} alt="" />
                       ...
                       <div  data-aos="fade-down" data-aos-duration="2000" className='absolute  left-[-150px] bottom-[-180px]'>
